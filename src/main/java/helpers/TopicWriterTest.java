...
public class TopicWriterTest {
    ...
    public static void main(String... args) throws Exception {
        ...
        String topicArn = "arn:aws:sns:us-east-2:743203956339:DlcmStack-DlcmInputTopic3467A01D-QKHDLR7RYNO7";
        ...
        try {
            ...
            final TopicWriter topicWriter = new TopicWriter(topicArn);
            try {
